""" 
    Since I considered "irrelevant" to know the in-details
    the real implementation for Hash Sets (because there're already 
    default functions out there). I'll copy/paste
